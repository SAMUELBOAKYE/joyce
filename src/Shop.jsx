...
const ingredients = [
  ...
  { name: "Onions", price: 10, image: onions },
  { name: "Pepper", price: 10, image: pepper },
  { name: "Garden Eggs", price: 10, image: gardenEggs },
  { name: "Koobi (Salted Fish)", price: 10, image: koobi },
  { name: "Tuna", price: 10, image: tuna },
  { name: "Goat Meat", price: 10, image: goatMeat },
  { name: "Ginger", price: 10, image: ginger },
  { name: "Garlic", price: 10, image: garlic },
  { name: "Kontomire", price: 10, image: kontomire },
  { name: "Cabbage", price: 10, image: cabbage },
  { name: "Palm Oil", price: 10, image: palmOil },
  { name: "Cassava", price: 10, image: cassava },
  { name: "Plantain", price: 10, image: plantain },
  { name: "Cassava Dough", price: 10, image: cassavaDough },
  { name: "Maize Dough", price: 10, image: maizeDough },
  { name: "Okro", price: 10, image: okro },
  { name: "Smoked Fish", price: 10, image: smokedFish },
];
